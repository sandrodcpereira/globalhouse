!(function (d) {
    ...
    var e = "string" == typeof __pageclip_base ? __pageclip_base : "https://send.pageclip.co",
        m = {
            _base: e,
            _successTemplate: '<div class="pageclip-form__success__message">Obrigado! <span>Entraremos em contacto em breve.</span></div>',
            ...
            send: function (e, t, s, n) {
                t = m._base + "/" + e + "/" + (t || "");
                m._send(e, t, { "X-REQMETHOD": "send-v1", "Content-Type": "application/json" }, JSON.stringify(s), {}, n);
            },
